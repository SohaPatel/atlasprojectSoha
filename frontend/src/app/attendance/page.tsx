  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0f172a", color: "#e2e8f0", fontFamily: "sans-serif" }}>
      ...
      <div style={{ background: "#1e293b", padding: "0 32px", borderBottom: "1px solid #334155", display: "flex", gap: "4px" }}>
        {["dashboard", "mark", "leave", "analyze"].map((tab) => (
        ...
        {activeTab === "leave" && (
          <div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
              {/* Submit Leave Form */}
              <div style={{ background: "#1e293b", borderRadius: "12px", padding: "24px", border: "1px solid #334155" }}>
                <h2 style={{ margin: "0 0 20px", fontSize: "16px", color: "#f8fafc" }}>📝 Submit Leave Request</h2>
                {[
              ...
              {/* Leave Requests List */}
              <div style={{ background: "#1e293b", borderRadius: "12px", padding: "24px", border: "1px solid #334155" }}>
                <h2 style={{ margin: "0 0 20px", fontSize: "16px", color: "#f8fafc" }}>📋 All Leave Requests</h2>
